...
const Hero = () => {
    return (
        <main className='w-full pt-10 md:pt-16 md:flex  '>
            <div id='left' className='w-full pl-10 md:w-[50%] '>
            ...
            <div id='right' className='w-full mt-6 md:w-[50%] '>
                <div id='whitebox' className='w-[96%] h-full mx-auto bg-white rounded-2xl border-[0.5px] border-gray-300'>
                    ...
                    <div id='p2' className='flex flex-col md:flex-row items-center gap-3 p-4'>
                        ...
                        <div className='w-full flex-1 min-h-[170px] rounded-xl border border-line bg-[repeating-linear-gradient(#fff,#fff_27px,#EDEAF7_28px)] p-4 flex items-center'>
                        ...
                        {/* RIGHT — Typed (clean) */}
                        <div className='w-full flex-1 min-h-[170px] rounded-xl bg-ink p-4 flex items-center overflow-hidden'>
                            <p className='font-sans text-paper text-xs sm:text-sm leading-relaxed animate-[sbFadeType_4.5s_ease-in-out_infinite]'>
                                ...
                                acceleration.
                                <span className='inline-block w-[6px] h-[13px] bg-coral ml-1 align-middle animate-[sbBlink_0.9s_steps(1)_infinite]'></span>
                            </p>
                        </div>
